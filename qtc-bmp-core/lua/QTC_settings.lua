...
QTC_commands.register("SQSettings_GetSettingsList_CMD", "SettingsList", "Show settings list")
...
QTC_commands.register("SQSettings_GetSettingsList_CMD", "SettingsSet", "Set an setting")
